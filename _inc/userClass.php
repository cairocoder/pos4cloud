<?php
    ...
    class userClass {
        ...
        public static function getDescName($descId) {
            global $db;

            $result2 = $db->query("SELECT `desc` FROM items_desc
        ...
        public static function getVendName($vendId) {
            global $db;
        ...
        public static function getGenderName($genderId) {
            ...
            $result2 = $db->query("SELECT `desc` FROM items_gender
                                   WHERE gender_id = {$genderId}");
            $row2 = $db->fetch_array($result2);
            $itemGender = $row2['desc'];
        ...
        public static function getSeasonName($seasonId) {
            ...
            $result2 = $db->query("SELECT `desc` FROM items_season
                                   WHERE season_id = {$seasonId}");
            $row2 = $db->fetch_array($result2);
            $itemSeason = $row2['desc'];

            return $itemSeason;
        }

        public static function getSubDeptName($subDeptId) {
            global $db;

            $result2 = $db->query("SELECT `desc` FROM items_sub_dept
                                   WHERE sub_dept_id = {$subDeptId}");
            $row2 = $db->fetch_array($result2);
            $itemSubDept = $row2['desc'];
        ...
        public static function getItemTotalSales($itemId, $locId = null, $dateFrom = null, $dateTo = null) {
            ...
            $salesReport = array("netSales"    => $totalSales - $totalReturn,
        ...
        public static function getItemTotalSales3($itemId, $locId = null, $month = null, $year = null, $dept = null, $season = null, $gender = null, $desc = null, $subDept = null, $brances = null) {
            global $db;
        ...
        public static function getItemTotalSalesValue2($itemId, $locId = null, $month = null, $year = null, $dept = null, $season = null, $gender = null, $desc = null, $subDept = null, $brances = null) {
            global $db;
            $query   = "SELECT SUM(invoice_detail.rtp * invoice_detail.qty) AS `rtp`
                        FROM `invoice_detail`
                        JOIN  invoice_header ON invoice_detail.invo_no = invoice_header.invo_no
        ...
        public static function getItemTotalStock($itemId, $locId = null, $dept = null, $season = null, $gender = null, $desc = null, $subDept = null, $brances = null) {
            global $db;
        ...
        public static function getItemTotalStockValue($itemId, $locId = null, $dept = null, $season = null, $gender = null, $desc = null, $subDept = null, $brances = null) {
            global $db;
        ...
        public static function getTypeTotalSales($type, $type_id, $locId = null, $month = null, $year = null, $dept = null, $season = null, $gender = null, $desc = null, $subDept = null, $brances = null) {
            global $db;
            $query   = "SELECT SUM(IF(invoice_detail.type=1, invoice_detail.qty, -1*invoice_detail.qty)) AS `qty` FROM `invoice_detail`
                        JOIN invoice_header ON invoice_detail.invo_no = invoice_header.invo_no
                        AND  invoice_detail.loc_id = invoice_header.loc_id
        ...
        public static function getTypeTotalSalesValue($type, $type_id, $locId = null, $month = null, $year = null, $dept = null, $season = null, $gender = null, $desc = null, $subDept = null, $brances = null) {
            global $db;
            $query   = "SELECT SUM(invoice_detail.rtp * invoice_detail.qty) AS `rtp`
                        FROM `invoice_detail`
                        JOIN invoice_header ON invoice_detail.invo_no = invoice_header.invo_no
        ...
        public static function getTypeTotalStock($type, $type_id, $locId = null, $dept = null, $season = null, $gender = null, $desc = null, $subDept = null, $brances = null) {
            global $db;
        ...
        public static function getTypeTotalStock2($type, $type_id, $year, $month, $dept = null, $season = null, $gender = null, $desc = null, $subDept = null) {
            global $db;
            $query   = "SELECT SUM(items_history.qty) AS `qty` FROM `items_history`
                        JOIN items ON items_history.item_id = items.item_id
                        WHERE items.".$type." = '{$type_id}'";

            if (!empty($year))
            {
                $query  .= " AND YEAR(items_history.date) IN ({$year})";
            }

            if (!empty($month))
            {
                $query  .= " AND MONTH(items_history.date) IN ({$month})";
            }
        ...
        public static function getTypeTotalStockValue($type, $type_id, $locId = null, $dept = null, $season = null, $gender = null, $desc = null, $subDept = null, $brances = null) {
            global $db;
            $query   = "SELECT SUM(warehouses.qty * items.rtp) AS `totalValue` FROM `warehouses`
                        JOIN items ON warehouses.item_id = items.item_id
                        WHERE items.".$type." = '{$type_id}'";
